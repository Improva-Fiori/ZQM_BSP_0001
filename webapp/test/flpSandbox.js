		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comkarsanqmsapmaportali-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkarsanqmsapmaportali-display": {
								"semanticObject": "comkarsanqmsapmaportali",
								"action": "display",
								"description": "Sapma Yönetim Sistemi",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.karsan.qm.sapmaportali",
									"url": sap.ui.require.toUrl("com/karsan/qm/sapmaportali")
								}
							}
						}
					}
